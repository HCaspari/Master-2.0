...
def Speed_achieved_Valid(perp_force, forward_force):
    """
    ...
    total_resistance_vector_2_knots = []
    ...
    for velocity in vessel_velocity:
        ...
        if total_resistance > forward_force:
            ...
            #TEST FOR BELOW 2 knots

            if speed_achieved < 2:
                # battery need is remaining power to get to 2 knots
                hydro_sailing_resistance_2_knots = Sailing_resistance(2) * ratio_hydrodyn_to_tot_res
                drift_angle_2_knots = Beta_solver(perp_force, 2)
                resistance_multiplier_2_knots = Drift_resistance_multiplier(drift_angle_2_knots)
                if resistance_multiplier_2_knots < 1:
                    total_resistance_2_knots = hydro_sailing_resistance_2_knots
                    total_resistance_vector_2_knots.append(total_resistance_2_knots)
                else:
                    total_resistance_2_knots = resistance_multiplier_2_knots * hydro_sailing_resistance_2_knots
                    total_resistance_vector_2_knots.append(total_resistance_2_knots)
            ...
            return speed_achieved,total_resistance,battery_need_power
